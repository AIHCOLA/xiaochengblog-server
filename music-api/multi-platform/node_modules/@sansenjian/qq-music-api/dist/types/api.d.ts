 ...
 * API 函数类型定义
 */
export type ApiFunction<TOptions extends ApiOptions = ApiOptions, TBody extends ApiResponseBody = ApiResponseBody> = (options: TOptions) => Promise<ApiResponse<TBody>>;
